...
const StarshipsDataGrid = (props) => {

    const {
        starshipsData, error, onSortChange, sortOrder, sortColumn, dispatchDeleteStarship,
        isOpen, onOpen, onClose, onEditItem, token, isAuthenticated, onCreateItem, label
    } = props;
